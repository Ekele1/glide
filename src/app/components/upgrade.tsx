...
const Upgrade = () => {
  return (
    <div className='w-full bg-[#1b1b1b] flex items-center justify-center lg:pt-30 pt-20'>
        <div className='w-[95%] flex flex-col gap-10'>
            <div className='w-full flex flex-col items-center justify-center text-white'>
                <p className='text-green-600 font-bold'>Ride Upgrade</p>
                <p className='lg:text-[40px] text-[25px] font-bold hidden lg:flex'>Upgrade Your Ride with Electric Energy</p>
